        ...
        <Container>
                        ...
                        (prod, idx) =>
                            ...
                            <tr key={prod.product._id}>
                                ...
                                <Mytd style={{verticalAlign: "middle", textAlign: "center"}}>
                                    <img src={process.env.REACT_APP_API_URL + prod.product.img} alt={"mini-image"}
                                         style={{width: "100%", height: "100%"}}
                                    ></img>
                                </Mytd>
                                <Mytd style={{verticalAlign: "middle", textAlign: "center"}}>
                                    {prod.product.title} </Mytd>
                                <Mytd> {prod.amount} </Mytd>
                                {/*<Mytd style={{verticalAlign: "middle", textAlign: "center"}}>  {-cart.total + (cart.total += prod.product.price * amount)}</Mytd>*/}
                                <Mytd style={{
                                    verticalAlign: "middle",
                                    textAlign: "center"
                                }}>  {prod.product.price * prod.amount}</Mytd>
                                <Mytd style={{
                                    verticalAlign: "middle",
                                    textAlign: "center"
                                }}>  {prod.product.description}</Mytd>
            ...
            >
                <Button
                    ...
                    size={"lg"} onClick={() => onOrderApprove({street: "Shevchenka", house_num: 40})}>Підтвердити
                    замовлення</Button>
            </StripeCheckout>
        </Container>
    );

            ...
            <Card
                ...
                <Card.Body>
                    <Card.Title className={"d-flex justify-content-center"}
                                style={{fontSize: "4vw"}}> {user.user.email}</Card.Title>
                    <Card.Text className={"d-flex justify-content-center"} style={{fontSize: "2vw"}}>
                        Role: {user.user.role}
                    </Card.Text>
                    ...
                    <Form className={"d-flex justify-content-center "}>
                        ...
                        <Button size={"lg"} style={{background: "none", border: 'none'}}
                                className={"mt-2 me-3 btn-info"} onClick={() => editName(user.user._id)}
                        > Edit
                        </Button>

                        <Button size={"lg"} style={{background: "none", border: 'none'}}
                                className={"mt-2 btn-info"} onClick={() => editName(user.user._id)}
                        > Delete
                        </Button>
                    </Form>
